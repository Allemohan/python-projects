...
# users table
users_table = {
    12345:["Mohan","mohan@", 1000],
    123456:["srinubabu","srinu@gmail.com",2500]}
# transcations table
...
def withdraw(user_name):
    ...
    if amount >= withdraw_amount:
        ...
        lg.warning(f'{withdraw_amount} withdraw successful and current balance is {users_table[user_name][2]}')
...
def deposite(user_name:int):
    ...
    if user_name in users_table:
        ...
        lg.warning(f'{deposite_amount} withdraw successful and current balance is {users_table[user_name][2]}')
        print(f'{deposite_amount} withdraw successful and current balance is {users_table[user_name][2]}')
    else:
        lg.warning("user not found")
        print("user not found") 
    pass
